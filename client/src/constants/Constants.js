...
export const gmailIcon = "../../img/gmail.png";
export const calenderIcon = "../../img/calender.png";
export const chatIcon = "../../img/chat.png";
export const contactsIcon = "../../img/contacts.png";
export const currentsIcon = "../../img/currents.png";
export const driveIcon = "../../img/dive.png";
export const docsIcon = "../../img/docs.png";
export const formsIcon = "../../img/forms.png";
export const meetIcon = "../../img/meet.png";
export const sheetIcon = "../../img/sheet.png";
export const siteIcon = "../../img/site.png";
export const slidesIcon = "../../img/slides.png";
export const accountIcon = "../../img/account.png";
